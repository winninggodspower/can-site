...
urlpatterns = [
    ...
    path('<int:course_id>/payment/initiate/', views.initiate_course_payment_view, name='initiate_payment'),
    path('payment/verify/', views.verify_course_payment_view, name='verify_payment'),
